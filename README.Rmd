...
The goal of this package HW3 is to facilitate get linear regression result and its analysis. It includes functions for building linear models($Y = X\beta +\epsilon$), making predictions, testing parameters, and summarizing model results.
