...
library(NHANES)
library(ggplot2)
model3 <- linear_model(NHANES[,c("Weight","Height")],NHANES$BPSysAve)
...
ggplot(plot_data, aes(x = Weight, y = BPSysAve)) + 
  ...
  ggtitle("Scatter plot with Fitted Line: Weight vs BPSysAve")

# Plot for Height vs BPSysAve
ggplot(plot_data, aes(x = Height, y = BPSysAve)) + 
  geom_point() + 
  geom_line(aes(y = FittedBPSysAve), color = "red") +
  ggtitle("Scatter plot with Fitted Line: Height vs BPSysAve")
